      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "askvortsov-trust-levels.forum.edit_user.trust_levels_heading"
          )}
        </label>
        {app.store.all("trust_levels").map((trustLevel) => (
          <label className="checkbox">
            ...
            />
            {app.translator.trans(
              "askvortsov-trust-levels.forum.edit_user.trust_level_item",
              {
                badge: GroupBadge.component({
                  group: trustLevel.group(),
                  label: "",
                }),
        ...
        <p>
          {app.translator.trans(
            "askvortsov-trust-levels.forum.edit_user.trust_levels_not_editable"
          )}
        </p>
      </div>,
      10
